...
const ProductCard = () => {
  return (
    <div className="w-[240px] min-h-[200px] overflow-hidden bg-white shadow-md shadow-black/30 rounded-2xl flex flex-col">
        ...
        <div className="w-full flex justify-between">
          <div className="flex flex-col font-baloo font-bold">
            <div className="relative text-xs px-1 w-fit flex items-center justify-center">
              <span className="text-gray-400 leading-3">R$ 100.00</span>
              <div className="absolute right-0 left-0 bg-gray-400 h-[1.5px] rounded-xl" />
            </div>
            <span className="text-[1.5rem] leading-7">R$ 89.90</span>
          </div>
